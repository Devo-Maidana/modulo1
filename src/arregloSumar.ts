let valor1: number[] = new Array(6);
let valor2: number[] = new Array(6);
let valorSuma: number[] = new Array(6);
let indice: number;
...
//Sumo los valores y muestro por pantalla (imrimo) la suma total de los 2
//ejemplo valor 1 (1,2,3,4,5,6) + valor2 (1,1,1,1,1,1)
